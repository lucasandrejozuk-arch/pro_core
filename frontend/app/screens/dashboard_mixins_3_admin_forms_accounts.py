...
class DashboardAdminAccountFormsMixin:
    def _build_sector_form(self) -> QFrame:
        ...
        sector_fields_panel.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        ...
        sector_fields_panel_layout.setAlignment(Qt.AlignmentFlag.AlignTop)
    ...
    def _build_user_form(self) -> QFrame:
        ...
        self.user_full_name_input.setClearButtonEnabled(True)
        self.user_full_name_input.setMinimumHeight(36)
        self.user_email_input = QLineEdit()
        self.user_email_input.setPlaceholderText("Email de login")
        self.user_email_input.setClearButtonEnabled(True)
        self.user_email_input.setMinimumHeight(36)
        ...
        self.user_role_combo.setMinimumHeight(36)
        self.user_sector_combo = QComboBox()
        self.user_sector_combo.setMinimumHeight(36)
        ...
        self.user_initial_password_input.setMinimumHeight(36)
        ...
        self.user_reset_password_input.setMinimumHeight(36)
        identity_layout = QFormLayout()
        identity_layout.setSpacing(10)
        identity_layout.setHorizontalSpacing(14)
        identity_layout.setLabelAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
        ...
        identity_panel_layout.setAlignment(Qt.AlignmentFlag.AlignTop)
        ...
        security_layout.setLabelAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
        security_layout.setFieldGrowthPolicy(QFormLayout.FieldGrowthPolicy.ExpandingFieldsGrow)
        ...
        security_panel.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        ...
        security_panel_layout.setAlignment(Qt.AlignmentFlag.AlignTop)
    ...
    def _build_resource_access_form(self) -> QFrame:
        ...
        for index, (key, label) in enumerate(resource_items):
            ...
            add_widget(resources_grid, checkbox, index // 3, (index % 3) * 4, 4)
        ...
        resources_panel.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        ...
        resources_panel_layout.setAlignment(Qt.AlignmentFlag.AlignTop)
        ...
        self.resource_access_scope_status = QLabel(
            "Escopo: administradores gerenciam todas as contas; gestores apenas "
            "subordinados do setor."
        )
