...
def build_dashboard_footer(self, scroll_area) -> None:
    ...
    self.backend_status_dot.setProperty("level", "warning")
    self.backend_status_text = QLabel("Backend: verificando")
    ...
    self.footer_message_frame = QFrame()
    self.footer_message_frame.setObjectName("footerMessageFrame")
    footer_message_layout = QHBoxLayout(self.footer_message_frame)
    footer_message_layout.setContentsMargins(8, 2, 8, 2)
    footer_message_layout.setSpacing(0)
    ...
    footer_message_layout.addWidget(self.footer_message_label)

    session_footer_layout.addWidget(self.session_footer_label)
    session_footer_layout.addStretch()
    session_footer_layout.addWidget(self.footer_message_frame, 1)
    ...
    self.command_context_label.setObjectName("topCommandContextTab")
    command_layout.addWidget(self.command_context_label)
    command_layout.addStretch()

    self.command_refresh_button = QPushButton("Atualizar", self)
    self.command_refresh_button.setObjectName("topCommandButton")
    ...
    self.command_editor_button.setObjectName("topCommandButton")
    ...
    self.command_clear_selection_button.setObjectName("topCommandButton")
